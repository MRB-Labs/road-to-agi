...
STAGE_MAP = {
 ...
 # ── Layer 6 ────────────────────────────────────────────────────────────────
 "6::Optical components and transceivers":        "L6.0.0",
 "6::Optical DSP and connectivity silicon":       "L6.0.0",
 "6::Fibre and optical cable":                    "L6.0.1",
 "6::Connectors and copper interconnect":         "L6.0.2",
 "6::Data-centre switching":                      "L6.0.3",
 "6::Optical transport and DCI":                  "L6.0.3",
 "6::Long-haul, metro and dark fibre":            "L6.0.5",
 "6::Subsea cable ownership/supply":              "L6.0.5",
 "6::CDN and edge delivery":                      "L6.0.6",
 "6::Wireless access and private networks":       "L6.0.7",
 "6::Satellite connectivity":                     "L6.0.7",

 # ── Layer 7 ────────────────────────────────────────────────────────────────
 "7::Cloud object/data storage":                  "L7.0.3",
 "7::Data warehouse and lakehouse":               "L7.0.3",
 "7::Operational databases":                      "L7.0.3",
 "7::Streaming and event data":                   "L7.0.2",
 "7::Ingestion and transformation":               "L7.0.2",
 "7::Catalogue, governance and lineage":          "L7.0.6",
 "7::Data observability":                         "L7.0.9",
 "7::Vector databases and retrieval":             "L7.0.8",
 "7::Annotation and data operations":             "L7.0.5",
 "7::Enterprise knowledge/search":                "L7.1.2",
 "7::Licensed content and data owners":           "L7.0.0",
 "7::Synthetic data and simulation data":         "L7.0.7",

 # ── Layer 8 ────────────────────────────────────────────────────────────────
 "8::General frontier-model developers":          "L8.0.3",
 "8::Open-model ecosystems":                      "L8.0.9",
 "8::Vertical/domain models":                     "L8.0.3",
 "8::Model training platforms":                   "L8.0.1",
 "8::Post-training and alignment":                "L8.0.4",
 "8::Evaluation and AI assurance":                "L8.0.5",
 "8::Optimisation and compilation":               "L8.0.6",
 "8::Inference engines and model serving":        "L8.0.7",
 "8::Model registry, monitoring and LLMOps":      "L8.0.8",

 # ── Layer 9 ────────────────────────────────────────────────────────────────
 "9::Enterprise agent platforms":                 "L9.0.6",
 "9::Model gateways and routing":                 "L9.0.0",
 "9::Agent frameworks and orchestration":         "L9.0.3",
 "9::Integration, iPaaS and automation":          "L9.0.7",
 "9::Process intelligence":                       "L9.0.7",
 "9::Coding agents and developer tools":          "L9.0.6",
 "9::Knowledge-work applications":                "L9.0.6",
 "9::Identity and privileged access":             "L9.1.0",
 "9::Observability and agent operations":         "L9.1.3",
 "9::Application security and AI security":       "L9.1.1",
 ...
 # 7 to 10, not a stage after the application. It lands in layer 9's control
 # plane, which is where this report already puts it.
 "X::Security domain":                            None,   # a table header, not a position
 "X::OT and critical-infrastructure security":    "L9.1.1",
 "X::Cloud and workload security":                "L9.1.1",
 "X::Identity and machine authorization":         "L9.1.0",
 "X::Data security and privacy":                  "L9.1.1",
 "X::AI/model/agent security":                    "L9.1.1",
 "X::Device, firmware and supply-chain security": "L9.1.1",
}
