...
const AtlasData = (() => {
  ...
  const atlasGlyphs = {
    ...
    10: '<circle cx="22" cy="8" r="4"/><path d="M22 12 V25"/><path d="M14 18 H30"/><path d="M16 18 L12 27"/><path d="M28 18 L32 27"/><path d="M18 25 L14 38"/><path d="M26 25 L30 38"/><path d="M12 27 L9 30"/><path d="M32 27 L35 30"/><path d="M12 38 H17"/><path d="M27 38 H32"/><path d="M18 15 C20 17 24 17 26 15"/><path d="M19 22 H25"/>',
    humanoid: '<rect x="15" y="5" width="14" height="12" rx="3"/><path d="M22 5 V2"/><circle cx="22" cy="2" r="1.4"/><circle cx="19" cy="10.5" r="1.2"/><circle cx="25" cy="10.5" r="1.2"/><path d="M19 14 H25"/><path d="M15 11 H12"/><path d="M29 11 H32"/><rect x="14" y="19" width="16" height="12" rx="3"/><path d="M22 17 V19"/><path d="M18 22 H26"/><path d="M18 26 H26"/><path d="M14 23 L9 30"/><path d="M30 23 L35 30"/><path d="M18 31 L14 39"/><path d="M26 31 L30 39"/><path d="M9 30 L6 33"/><path d="M35 30 L38 33"/><path d="M12 39 H17"/><path d="M27 39 H32"/>',
    ...
    act: '<path d="M22 7 V20"/><rect x="15" y="18" width="14" height="8" rx="3"/><circle cx="22" cy="22" r="2.5"/><path d="M15 23 L9 28"/><path d="M29 23 L35 28"/><path d="M9 28 C7 31 8 35 12 37"/><path d="M35 28 C37 31 36 35 32 37"/><path d="M12 37 L18 30"/><path d="M32 37 L26 30"/><path d="M18 30 L20 26"/><path d="M26 30 L24 26"/><path d="M18 10 H26"/><path d="M19 7 H25"/>',
    battery: '<rect x="8" y="15" width="26" height="16" rx="3"/><path d="M34 20 H38 V26 H34"/><path d="M19 17 L14 25 H20 L17 31 L27 21 H21 L24 17 Z"/><path d="M11 19 V27"/><path d="M30 19 V27"/>'
  };
