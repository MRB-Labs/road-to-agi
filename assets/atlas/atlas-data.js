...
const AtlasData = (() => {
  ...
  const atlasGlyphs = {
    ...
    humanoid: '<circle cx="22" cy="7.5" r="4.8"/><path d="M22 12.5 V25.5"/><path d="M14 17.5 H30"/><path d="M14 17.5 L9.5 27.5"/><path d="M30 17.5 L34.5 27.5"/><path d="M18.5 25.5 L14 38"/><path d="M25.5 25.5 L30 38"/><path d="M10 27.5 L7 31"/><path d="M34 27.5 L37 31"/><path d="M11.5 38 H17"/><path d="M27 38 H32.5"/><path d="M17.5 15 C20 17.5 24 17.5 26.5 15"/><path d="M18.5 21.5 H25.5"/><path d="M19 25.5 H25"/>',
